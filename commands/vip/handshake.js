...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        // perm checks
            ...
            message.delete();
            message.channel.send(new Discord.MessageEmbed().setColor(config.color).setDescription(`${message.author} shook hands with <@${message.mentions.members.first().id}>! 🤝`));
