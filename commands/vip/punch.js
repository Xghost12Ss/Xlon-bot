...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        // perm checks
            ...
            message.delete();
            message.channel.send(new Discord.MessageEmbed().setColor(config.color).setDescription(`${message.author} punched <@${message.mentions.members.first().id}> in the face! 🤜 💢`));
